/**
 * REAL TURKEY HOTELS DATABASE SEED - UPDATED WITH UNSPLASH IMAGES
...
const ANTALYA_HOTELS = [
  {
    ...
    checkIn: '14:00',
    checkOut: '12:00',
    description: 'G7 Liderler Zirvesi\'ne ev sahipliği yapmış 5 yıldızlı ultra lüks resort. PGA standartlarında 18 delikli golf sahası, infinity havuzlar ve özel plaj ile unutulmaz tatil deneyimi.',
    shortDescription: '5 yıldızlı ultra lüks golf resort. PGA standartlarında golf sahası.',
    mainImage: 'https://images.unsplash.com/photo-1564501049412-61c2a3083791?w=1200&h=800&fit=crop',
    hotelType: 'Resort',
    roomCount: 450,
    yearBuilt: 2009,
    yearRenovated: 2021,
    ...
    facilities: JSON.stringify(['Golf', 'Spa', 'Aquapark', 'Beach', 'Restaurant', 'Bar', 'Gym', 'Kids Club']),
    ...
    distanceToAirport: 30.0,
    distanceToCenter: 35.0,
    distanceToBeach: 0.1,
    isFeatured: true,
    isRecommended: true,
    isActive: true
  },
  {
    ...
    checkIn: '14:00',
    checkOut: '12:00',
    description: 'Rixos zincirinin Belek\'teki en prestijli oteli. Ultra All Inclusive konsept ile sınırsız lüks, aquapark, Rixy Kids Club ve Anjana Spa ile mükemmel tatil.',
    shortDescription: 'Rixos\'un Belek\'teki ultra lüks oteli. Ultra All Inclusive.',
    ...
    facilities: JSON.stringify(['Aquapark', 'Spa', 'Beach', 'Restaurant', 'Bar', 'Kids Club', 'Gym']),
    roomTypes: JSON.stringify([
  ...
  },
  {
    ...
    checkIn: '14:00',
    checkOut: '12:00',
    description: 'Titanic gemisini andıran görkemli mimarisiyle ünlü ultra lüks resort. 2 km uzunluğunda özel kumsal, aquapark ve 10 restoran ile unutulmaz deneyim.',
    shortDescription: 'Görkemli mimari, 2 km kumsal ve aquapark.',
    mainImage: 'https://images.unsplash.com/photo-1568992687947-868a62a9f521?w=1200&h=800&fit=crop',
    hotelType: 'Resort',
    roomCount: 586,
    yearBuilt: 2009,
    yearRenovated: 2019,
    ...
    facilities: JSON.stringify(['Aquapark', 'Spa', 'Beach', 'Restaurant', 'Bar', 'Kids Club', 'Pool']),
    roomTypes: JSON.stringify([
    ...
    images: JSON.stringify([
      ...
      'https://images.unsplash.com/photo-1571770095004-6b61b1cf308a?w=800&h=600&fit=crop'
    ]),
  ...
  },
  {
    ...
    checkIn: '14:00',
    checkOut: '12:00',
    description: 'Lara\'nın ünlü kumsal plajında konumlanmış aile dostu resort. Geniş aquapark, animasyon programları ve 7 restoran.',
    shortDescription: 'Aile dostu resort, aquapark ve animasyon.',
    ...
    facilities: JSON.stringify(['Aquapark', 'Spa', 'Beach', 'Restaurant', 'Bar', 'Kids Club', 'Animation']),
    roomTypes: JSON.stringify([
  ...
  },
  {
    ...
    shortDescription: 'Toros Dağları ve Akdeniz arasında ultra lüks.',
    ...
    facilities: JSON.stringify(['Aquapark', 'Spa', 'Beach', 'Restaurant', 'Bar', 'Kids Club', 'Mountain View']),
    roomTypes: JSON.stringify([
    ...
    distanceToAirport: 48.0,
    distanceToCenter: 42.0,
    distanceToBeach: 0.05,
    isFeatured: true,
    isRecommended: true,
    isActive: true
  },
  {
    ...
    checkIn: '14:00',
    checkOut: '12:00',
    description: 'Alanya\'nın en büyük aquapark\'ına sahip all inclusive resort. 18.000 m² aquapark alanı ve 24 kaydırak ile su tutkunları için cennet.',
    shortDescription: 'Türkiye\'nin en büyük aquapark\'ı, 24 kaydırak.',
    mainImage: 'https://images.unsplash.com/photo-1609137144813-7d9921338f24?w=1200&h=800&fit=crop',
    hotelType: 'Resort',
    roomCount: 540,
    yearBuilt: 1998,
    yearRenovated: 2017,
    ...
    facilities: JSON.stringify(['Aquapark', 'Spa', 'Beach', 'Restaurant', 'Bar', 'Kids Club']),
    roomTypes: JSON.stringify([
...
const ISTANBUL_HOTELS = [
  {
    ...
    checkIn: '15:00',
    checkOut: '12:00',
    description: '1919 tarihli neoklasik hapishaneden dönüştürülmüş tarihi otel. Ayasofya ve Sultanahmet Camii manzarası. Lüks spa, çatı terası ve dünya çapında ödüllü servis.',
    shortDescription: 'Tarihi hapishane binasında lüks otel. Ayasofya manzarası.',
    mainImage: 'https://images.unsplash.com/photo-1566073771259-6a8506862ae3?w=1200&h=800&fit=crop',
    hotelType: 'Boutique',
    roomCount: 65,
    yearBuilt: 1919,
    yearRenovated: 2018,
    ...
    facilities: JSON.stringify(['Spa', 'Restaurant', 'Bar', 'Concierge', 'Room Service', 'WiFi', 'Rooftop Terrace']),
    roomTypes: JSON.stringify([
  ...
  },
  {
    ...
    checkIn: '15:00',
    checkOut: '12:00',
    description: 'Osmanlı Sarayı\'ndan dönüştürülmüş ultra lüks otel. Boğaz kıyısında eşsiz konum, infinity pool, helipad ve butler service ile kraliyet deneyimi.',
    shortDescription: 'Osmanlı Sarayı, Boğaz kıyısı, ultra lüks.',
    mainImage: 'https://images.unsplash.com/photo-1564501049412-61c2a3083791?w=1200&h=800&fit=crop',
    hotelType: 'Palace',
    roomCount: 315,
    yearBuilt: 1874,
    ...
    facilities: JSON.stringify(['Spa', 'Pool', 'Restaurant', 'Bar', 'Helipad', 'Butler Service', 'Private Pier']),
    roomTypes: JSON.stringify([
...
const BODRUM_HOTELS = [
  {
    ...
    checkIn: '14:00',
    checkOut: '12:00',
    description: 'Bodrum Marina manzaralı modern ve şık otel. Şehir merkezinde premium konum, infinity pool ve beach club.',
    shortDescription: 'Marina manzaralı modern otel, merkezi konum.',
    mainImage: 'https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?w=1200&h=800&fit=crop',
    hotelType: 'Boutique',
    roomCount: 97,
    yearBuilt: 2001,
    yearRenovated: 2019,
    ...
    facilities: JSON.stringify(['Spa', 'Pool', 'Restaurant', 'Bar', 'Gym', 'Beach Club', 'Marina View']),
    roomTypes: JSON.stringify([
...
async function main() {
  console.log('🌍 Seeding real Turkey hotel data with Unsplash images...');
