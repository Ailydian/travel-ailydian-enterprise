    ...
    <div className={`w-full ${className}`}>
      ...
      >
        <div className="mb-6">
          ...
          <p className="text-gray-300">Nereden nereye gitmek istersiniz? Konforlu yolculuğunuz için hemen rezervasyon yapın.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
          ...
          <div className="md:col-span-2 flex justify-center">
            <button
              ...
              className="p-3 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-110"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
          ...
          <div>
            ...
            <div className="relative">
              <Car className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400 pointer-events-none" />
              <select
                value={vehicleType}
          ...
          >
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-medium text-gray-200">Rota</div>
        ...
        <div className="mt-6 pt-6 border-t border-white/10">
          <div className="text-sm font-semibold text-gray-200 mb-3">Popüler Rotalar</div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {POPULAR_ROUTES.map(route => (
              <button
                ...
                className="p-3 bg-white/5 hover:bg-blue-50 rounded-lg border border-white/10 hover:border-blue-300 transition-all text-left group"
              >
                ...
                <div className="text-xs text-gray-300">{route.to}</div>
