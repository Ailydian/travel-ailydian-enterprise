  ...
  return (
    <div className={`w-full ${className}`}>
      <motion.div
        ...
        className="bg-gradient-to-br from-slate-900 via-black to-slate-800 rounded-2xl shadow-2xl border border-white/10 p-6 md:p-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-400">Nereden nereye gitmek istersiniz? Konforlu yolculuğunuz için hemen rezervasyon yapın.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
          ...
          <div className="md:col-span-2 flex justify-center">
            <button
              ...
              className="p-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-110"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
          ...
          <div>
            ...
            <div className="relative">
              <Calendar className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-300 pointer-events-none" />
              <input
                type="datetime-local"
                value={dateTime}
                onChange={(e) => onDateTimeChange(e.target.value)}
                min={getMinDateTime()}
                className="w-full pl-12 pr-4 py-4 text-base bg-gradient-to-br from-slate-900 via-black to-slate-800 border-2 border-white/10 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-white font-medium shadow-sm hover:shadow-md hover:border-blue-500 transition-all duration-200" />
          ...
          <div>
            ...
            <div className="relative">
              <Users className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-300 pointer-events-none" />
              <select
                value={passengers}
                onChange={(e) => onPassengersChange(e.target.value)}
                className="w-full pl-12 pr-10 py-4 text-base bg-gradient-to-br from-slate-900 via-black to-slate-800 border-2 border-white/10 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-white font-medium shadow-sm hover:shadow-md hover:border-blue-500 transition-all duration-200 appearance-none cursor-pointer">
          ...
          <div>
            ...
            <div className="relative">
              <Car className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-300 pointer-events-none" />
              <select
                value={vehicleType}
        ...
        <div className="mt-6">
          <button
            onClick={onSearch}
            disabled={!from || !to}
            className="w-full py-4 px-6 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 disabled:from-gray-300 disabled:to-gray-400 text-white font-bold rounded-xl shadow-lg hover:shadow-xl disabled:shadow-none transition-all duration-200 transform hover:scale-[1.02] disabled:scale-100 disabled:cursor-not-allowed flex items-center justify-center gap-3 text-lg">
        ...
        <div className="mt-6 pt-6 border-t border-white/10">
          <div className="text-sm font-semibold text-gray-300 mb-3">Popüler Rotalar</div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <button
              ...
              className="p-3 bg-gradient-to-br from-slate-900 via-black to-slate-800 hover:bg-blue-500/10 rounded-lg border border-white/10 hover:border-blue-500 transition-all text-left group">

                <div className="flex items-center justify-between mb-1">
                  <span className="text-sm font-semibold text-white group-hover:text-blue-500 transition-colors">
                    {route.from}
                  </span>
                  <ArrowRight className="w-4 h-4 text-gray-300 group-hover:text-blue-500" />
                </div>
                <div className="text-xs text-gray-400">{route.to}</div>
