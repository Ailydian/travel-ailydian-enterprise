...
const CarRentalSearchEngine: React.FC<CarRentalSearchEngineProps> = ({ onSearch }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 via-black to-slate-800 rounded-2xl shadow-2xl p-6 md:p-8">
      {/* Pickup Location */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div className="relative">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 pl-12 border-2 border-white/20/10 rounded-xl focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none transition-all" />

            <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-300" />

            {showPickupSuggestions &&
            <div className="absolute z-50 w-full mt-2 bg-gradient-to-br from-slate-900 via-black to-slate-800 border border-white/20/10 rounded-xl shadow-lg max-h-60 overflow-y-auto">
              ...
              <button
                ...
                className="w-full text-left px-4 py-3 hover:bg-green-600-lighter transition-colors flex items-center gap-2">
        ...
        <div className="flex items-end">
            ...
            className="w-full px-4 py-3 border-2 border-dashed border-white/20 rounded-xl hover:border-green-500 hover:bg-green-600-lighter transition-all text-gray-400 hover:text-green-500-text font-medium">
      ...
      <div className="mb-4">
          ...
          className="text-sm text-green-500 hover:text-green-500-text font-medium flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 border-2 border-white/20/10 rounded-xl focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none transition-all" />
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-3 border-2 border-white/20/10 rounded-xl focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none transition-all appearance-none">
      ...
      <button
        ...
        className="w-full px-8 py-4 bg-gradient-to-r from-lydian-success to-lydian-success text-white rounded-xl font-bold text-lg hover:shadow-xl transition-all transform hover:scale-[1.02] flex items-center justify-center gap-3">
      ...
      {/* Quick Stats */}
      <div className="mt-6 grid grid-cols-3 gap-4 pt-6 border-t border-white/20/10">
        <div className="text-center">
          <div className="text-2xl font-bold text-green-500">1,200+</div>
          <div className="text-xs text-gray-400">Aktif Araç</div>
        </div>
        <div className="text-center">
        ...
        <div className="text-center">
          ...
          <div className="text-xs text-gray-400">En Düşük Fiyat</div>
        </div>
      </div>
    </div>);
