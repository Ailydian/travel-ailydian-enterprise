          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-3">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="relative w-12 h-12 flex items-center justify-center bg-gradient-to-br from-[#667EEA]/20 to-[#00BAFF]/20 backdrop-blur-xl border border-white/30 rounded-2xl shadow-lg group"
              >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="lg:hidden w-12 h-12 flex items-center justify-center bg-white/10 backdrop-blur-xl border border-white/30 rounded-2xl"
              >
        ...
        <AnimatePresence>
          {searchOpen && (
            <motion.div
              ...
              className="relative border-t border-white/20 bg-white/5 backdrop-blur-2xl"
            >
              <div className="max-w-4xl mx-auto px-6 py-6">
                <div className="relative">
                  <input
                    ...
                    className="w-full px-6 py-4 pl-14 bg-white/10 backdrop-blur-xl border-2 border-white/30 rounded-3xl text-white placeholder-white/60 focus:border-[#667EEA] focus:ring-4 focus:ring-[#667EEA]/20 outline-none transition-all"
                    autoFocus
                  />
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {['Antalya Turları', 'Havalimanı Transfer', 'Lüks Araç', 'Kapadokya Otel'].map((suggestion) => (
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="px-4 py-2 bg-white/5 backdrop-blur-sm border border-white/20 rounded-full text-white/80 text-sm hover:bg-white/10 transition-all"
                    >
  ...
  return (
    <Link href={href}>
      <motion.div
        whileHover={{ scale: 1.1, y: -2 }}
        whileTap={{ scale: 0.95 }}
        className="relative w-12 h-12 flex items-center justify-center bg-white/10 backdrop-blur-xl border border-white/30 rounded-2xl shadow-lg cursor-pointer group"
      >
        ...
        {badge !== undefined && badge > 0 && (
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            className="absolute -top-2 -right-2 w-6 h-6 flex items-center justify-center bg-gradient-to-br from-red-500 to-red-600 rounded-full text-white text-xs font-bold shadow-lg"
          >
            {badge}
          </motion.div>
        )}
