          ...
          >
            ...
            <div className="absolute top-4 left-4 right-4 flex items-center justify-between pointer-events-auto">
              <div className="bg-black/50 backdrop-blur-md rounded-xl px-4 py-2 text-white">
                ...
                <p className="text-sm text-gray-400">{currentScene.description}</p>
              </div>
              ...
              {selectedHotspot.action && (
                ...
                >
                  <button
                    ...
                    className="w-full p-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-medium hover:bg-lydian-primary-hover transition-colors"
                  >
