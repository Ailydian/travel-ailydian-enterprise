    ...
    <div className={`relative ${className}`}>
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          'text-gray-300 hover:bg-lydian-bg/10'}`
          }
        ...
        <button
          ...
          className="p-2 rounded-lg text-gray-400 hover:bg-white/10 backdrop-blur-xl border border-white/20 transition-colors"
      ...
      <AnimatePresence>
        ...
        <motion.div
          ...
          exit={{ opacity: 0, scale: 0.95, y: -10 }}>
            ...
            <div className="absolute top-full right-0 mt-2 w-72 bg-gradient-to-br from-slate-900 via-black to-slate-800 rounded-xl shadow-xl border border-white/20/10 p-4 z-50">
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className="p-1 hover:bg-white/10 backdrop-blur-xl border border-white/20 rounded">
            ...
            <div className="space-y-2">
              ...
              <button
                ...
                className="w-full text-left px-3 py-2 rounded-lg bg-gradient-to-r from-blue-50 to-purple-50 hover:from-blue-100 hover:to-purple-100 transition-colors text-sm font-medium text-gray-300 border border-blue-100">
          ...
          exit={{ opacity: 0 }}>
            ...
            <motion.div
              ...
              <div
                ...
                className="bg-gradient-to-br from-slate-900 via-black to-slate-800 rounded-2xl w-full max-w-4xl max-h-[80vh] overflow-y-auto">

              {/* Modal Header */}
              <div className="sticky top-0 bg-gradient-to-br from-slate-900 via-black to-slate-800 border-b border-white/20/10 px-6 py-4 rounded-t-2xl">
                ...
                {!isSupported ?
                  ...
                  <div className="space-y-6">
                    ...
                    <div key={category} className="space-y-3">
                        ...
                        <div
                          key={index}
                          className="bg-gradient-to-br from-slate-900 via-black to-slate-800 border border-white/20/10 rounded-xl p-4 hover:shadow-md transition-shadow">
                            ...
                            <span
                              key={pIndex}
                              className="px-2 py-1 bg-white/10 backdrop-blur-xl border border-white/20 text-gray-300 text-xs rounded-lg">

                                    &quot;{pattern}&quot;
                                  </span>
                            )}
                                {command.patterns.length > 3 &&
                            <span className="px-2 py-1 bg-gradient-to-br from-slate-900 via-black to-slate-800 text-gray-300 text-xs rounded-lg">
                    ...
                    {/* Usage Tips */}
                    <div className="bg-yellow-500-lighter border border-yellow-200 rounded-xl p-4">
                      <h4 className="font-semibold text-yellow-800 mb-2 flex items-center gap-2">
                        <Zap className="w-4 h-4" />
                        Kullanım İpuçları
                      </h4>
                      <ul className="text-sm text-yellow-500-text space-y-1">
