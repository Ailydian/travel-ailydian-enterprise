    ...
    <div className={`flex flex-wrap items-center gap-2 ${className}`}>
      ...
      {chips.length > 1 && (
        <motion.button
          ...
          animate={{ opacity: 1, scale: 1 }}
          onClick={onClearAll}
          className="flex items-center gap-1.5 px-3 py-1.5 bg-white/10 text-gray-200 rounded-full text-sm font-medium hover:bg-gray-200 transition-colors border border-white/10"
        >
