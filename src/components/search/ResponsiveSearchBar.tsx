  ...
  return (
    <div ref={searchRef} className="w-full">
      ...
      <motion.button
        ...
        className="w-full bg-lydian-glass-dark rounded-2xl shadow-lg p-4 flex items-center gap-3 active:scale-98 transition-transform touch-target"
        whileTap={{ scale: 0.98 }}>
          ...
          <div className="flex-1 text-left">
            <p className="font-semibold text-lydian-text-inverse">Nereye gidiyorsun?</p>
            <p className="text-sm text-lydian-text-muted">Otel, uçuş veya transfer ara</p>
          </div>
          <ChevronRight className="w-5 h-5 text-lydian-text-muted" />
        </motion.button> : (
      ...
      <motion.div
        ...
        className={`bg-lydian-glass-dark rounded-3xl shadow-2xl ${
        isMobile ?
        ...
        'relative'}`
          ...
          <div className="p-4 md:p-6">
            {/* Mobile Header */}
            {isMobile &&
          <div className="flex items-center justify-between mb-4 pb-4 border-b border-lydian-border-light/10">
                <h3 className="text-lg font-bold text-lydian-text-inverse">Ara</h3>
                <button
              onClick={() => setIsExpanded(false)}
              className="w-10 h-10 rounded-xl bg-lydian-glass-dark-medium hover:bg-lydian-bg-active flex items-center justify-center transition-colors touch-target"
              aria-label="Kapat">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
              ...
              <div className="md:col-span-4">
                <label className="block text-xs font-semibold text-lydian-text-muted mb-2 ml-1">
            ...
            className="button-responsive w-full mt-4 bg-gradient-to-r from-lydian-primary to-lydian-secondary text-lydian-text-inverse font-semibold disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-xl active:scale-95 transition-all">
          ...
          <div className="mt-6 pt-6 border-t border-lydian-border-light/10">
                <p className="text-xs font-semibold text-lydian-text-muted uppercase tracking-wider mb-3">
                  Popüler Aramalar
                </p>
              ...
              <button
                ...
                className="w-full flex items-center gap-3 p-3 rounded-xl bg-lydian-glass-dark hover:bg-lydian-glass-dark-medium active:bg-lydian-bg-active transition-colors touch-target text-left">

                      <TrendingUp className="w-4 h-4 text-lydian-primary" />
                      <span className="text-sm font-medium text-lydian-text-inverse">{query}</span>
                    </button>
              )}
                </div>
              </div>
