  ...
  return (
    <div ref={searchRef} className="w-full">
      ...
      <motion.button
        ...
        className="w-full bg-gradient-to-br from-slate-900 via-black to-slate-800 rounded-2xl shadow-lg p-4 flex items-center gap-3 active:scale-98 transition-transform touch-target"
        whileTap={{ scale: 0.98 }}>
          ...
          <div className="flex-1 text-left">
            ...
            <p className="text-sm text-gray-300">Otel, uçuş veya transfer ara</p>
          </div>
      ...
      <motion.div
        ...
        className={`bg-gradient-to-br from-slate-900 via-black to-slate-800 rounded-3xl shadow-2xl ${
        isMobile ?
        ...
        'relative'}`
          ...
          <div className="p-4 md:p-6">
            {/* Mobile Header */}
            {isMobile &&
          <div className="flex items-center justify-between mb-4 pb-4 border-b border-white/20/10">
                <h3 className="text-lg font-bold text-white">Ara</h3>
                <button
              onClick={() => setIsExpanded(false)}
              className="w-10 h-10 rounded-xl bg-white/10 backdrop-blur-xl border border-white/20 hover:bg-white/10 backdrop-blur-xl border border-white/20 flex items-center justify-center transition-colors touch-target"
              aria-label="Kapat">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            ...
            className="button-responsive w-full mt-4 bg-gradient-to-r from-blue-600 to-purple-700 text-white font-semibold disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-xl active:scale-95 transition-all">
          ...
          <div className="mt-6 pt-6 border-t border-white/20/10">
              ...
              <button
                ...
                className="w-full flex items-center gap-3 p-3 rounded-xl bg-gradient-to-br from-slate-900 via-black to-slate-800 hover:bg-white/10 backdrop-blur-xl border border-white/20 active:bg-white/10 backdrop-blur-xl border border-white/20 transition-colors touch-target text-left">
