...
const AdvancedSearchDiscovery: React.FC<AdvancedSearchDiscoveryProps> = ({
  ...
  const LocationCard: React.FC<{ location: Location }> = ({ location }) => (
    <div 
      className="bg-white/5 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 overflow-hidden cursor-pointer border border-gray-100"
  ...
  return (
        ...
        <div className="relative">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-12 py-4 border border-white/20 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-lg"
            />
            <button
          ...
          {showSuggestions && suggestions.length > 0 && (
            <div className="absolute top-full left-0 right-0 bg-white/5 border border-white/10 rounded-lg shadow-lg z-10 max-h-96 overflow-y-auto">
              {suggestions.map((suggestion, idx) => (
                <button
                  key={idx}
                  onClick={() => handleSuggestionSelect(suggestion)}
                  className="w-full flex items-center space-x-3 px-4 py-3 hover:bg-white/5 text-left"
                >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className={`lg:col-span-1 ${showFilters ? 'block' : 'hidden lg:block'}`}>
          <div className="bg-white/5 rounded-lg shadow-sm border border-white/10 p-6 sticky top-6">
              ...
              <div className="space-y-2">
                {PRICE_RANGES.map(price => (
                  <label key={price.value} className="flex items-center">
                    ...
                    <span className="text-sm text-gray-300">{price.description}</span>
                  </label>
                ))}
              </div>
            </div>
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              {!showFilters && (
                <button
                  ...
                  className="lg:hidden flex items-center space-x-2 text-gray-300 hover:text-white"
                >
              ...
              <div className="flex justify-center mt-8">
                <div className="flex space-x-2">
                  <button
                    ...
                    className="px-4 py-2 border border-white/20 rounded-md disabled:opacity-50 hover:bg-white/5"
                  >
