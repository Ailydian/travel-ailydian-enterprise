      ...
      <div className="relative group">
        ...
        {showControls && canScrollLeft && (
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            className="absolute left-4 top-1/2 -translate-y-1/2 z-20 w-12 h-12 bg-white/10 backdrop-blur-xl border border-white/20 rounded-full flex items-center justify-center shadow-lg hover:bg-white/20 transition-all opacity-0 group-hover:opacity-100"
          >
        ...
        {showControls && canScrollRight && (
          <motion.button
            ...
            whileHover={{ scale: 1.1, x: 5 }}
            whileTap={{ scale: 0.9 }}
            className="absolute right-4 top-1/2 -translate-y-1/2 z-20 w-12 h-12 bg-white/10 backdrop-blur-xl border border-white/20 rounded-full flex items-center justify-center shadow-lg hover:bg-white/20 transition-all opacity-0 group-hover:opacity-100"
          >
