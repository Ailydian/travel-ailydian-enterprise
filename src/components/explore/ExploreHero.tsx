  ...
  return (
    <div className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-pink-500 overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-20 right-20 w-32 h-32 bg-white/10 backdrop-blur-xl border border-white/20 rounded-full blur-xl" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-20 sm:py-28">
        <div className="text-center space-y-8">
          ...
          <motion.div
            ...
            <div className="bg-gradient-to-br from-slate-900 via-black to-slate-800 rounded-2xl shadow-2xl p-6">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 border border-white/20 rounded-lg focus:ring-2 focus:ring-lydian-primary focus:border-white/20" />
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <select className="w-full pl-10 pr-4 py-3 border border-white/20 rounded-lg focus:ring-2 focus:ring-lydian-primary focus:border-white/20 appearance-none">
                ...
                <div className="flex items-end">
                  <button className="w-full bg-gradient-to-r from-blue-600 to-purple-700 text-white py-3 px-6 rounded-lg font-bold hover:shadow-xl transition-all flex items-center justify-center gap-2">
