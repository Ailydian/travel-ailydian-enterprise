...
export const ExploreHero: React.FC = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-lydian-primary via-lydian-secondary to-pink-500 overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-20 right-20 w-32 h-32 bg-lydian-glass-dark-medium rounded-full blur-xl" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-20 sm:py-28">
        <div className="text-center space-y-8">
          ...
          <motion.div
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-lydian-text-inverse">
              {t('explore.hero.title')}
            </h1>
            <p className="text-xl sm:text-2xl text-lydian-text-inverse/90 max-w-3xl mx-auto">
          ...
          <motion.div
            ...
            <div className="bg-lydian-glass-dark rounded-2xl shadow-2xl p-6">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 border border-lydian-border-light rounded-lg focus:ring-2 focus:ring-lydian-primary focus:border-lydian-border" />
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <select className="w-full pl-10 pr-4 py-3 border border-lydian-border-light rounded-lg focus:ring-2 focus:ring-lydian-primary focus:border-lydian-border appearance-none">
                ...
                <div className="flex items-end">
                  <button className="w-full bg-gradient-to-r from-lydian-primary to-lydian-secondary text-lydian-text-inverse py-3 px-6 rounded-lg font-bold hover:shadow-xl transition-all flex items-center justify-center gap-2">
          ...
          <motion.div
            ...
            className="flex flex-wrap justify-center gap-8 text-lydian-text-inverse">
