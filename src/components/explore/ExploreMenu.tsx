            ...
            <div className="grid grid-cols-12 gap-6 p-6">
              ...
              <div className="col-span-4 border-l border-white/10 pl-6">
                ...
                <Link
                  href="/explore"
                  onClick={() => setIsOpen(false)}
                  className="mt-4 flex items-center justify-center gap-2 py-2.5 px-4 bg-gradient-to-r from-lydian-primary to-lydian-secondary text-white rounded-lg hover:shadow-lg transition-all font-medium text-sm"
                >
