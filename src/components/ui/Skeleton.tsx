...
export const SkeletonCard: React.FC<SkeletonCardProps> = ({
  ...
  return (
    <div className={`p-6 bg-lydian-bg rounded-lg border border-white/20 ${className}`}>
      {/* Header with Avatar */}
      {showAvatar && (
  ...
  return (
    <div className={`space-y-4 ${className}`}>
      {Array.from({ length: items }).map((_, index) => (
        <div key={index} className="flex items-center gap-4 p-4 bg-lydian-bg rounded-lg border border-white/20">
...
export const SkeletonTable: React.FC<SkeletonTableProps> = ({
  ...
  return (
    <div className={`overflow-hidden rounded-lg border border-white/20 ${className}`}>
...
export const SkeletonProductCard: React.FC<{ className?: string }> = ({ className = '' }) => {
  return (
    <div className={`bg-lydian-bg rounded-lg border border-white/20 overflow-hidden ${className}`}>
      {/* Image */}
  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="p-6 bg-lydian-bg rounded-lg border border-white/20">
      ...
      {/* Chart */}
      <div className="p-6 bg-lydian-bg rounded-lg border border-white/20">
