...
}: {onLocationSelect?: (location: MapLocation) => void;allowCustomMarkers?: boolean;onPickupLocationChange?: (location: MapLocation | null) => void;showPickupOption?: boolean;}) {
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 text-sm">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-1">
              <span className="w-3 h-3 bg-lydian-error rounded-full"></span>
              <span>Otel</span>
            </div>
            <div className="flex items-center gap-1">
