      ...
      >
        ...
        {activeFilterCount > 0 && (
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            className="absolute -top-2 -right-2 w-7 h-7 bg-gradient-to-br from-orange-500 to-red-500 rounded-full flex items-center justify-center text-white text-xs font-bold shadow-lg"
          >
            {activeFilterCount}
          </motion.div>
        )}
        ...
        {isOpen && (
          <>
            ...
            >
              ...
              <div className="h-full bg-white/80 backdrop-blur-3xl border-l border-white/40 shadow-2xl overflow-hidden">

                {/* Header */}
                <div className="sticky top-0 z-10 bg-gradient-to-r from-[#667EEA]/10 via-[#764BA2]/10 to-[#667EEA]/10 backdrop-blur-xl border-b border-white/30 p-6">
                  ...
                  {activeFilterCount > 0 && (
                    <motion.button
                      ...
                      className="w-full px-4 py-2 bg-red-50 border border-red-200 rounded-xl text-red-600 font-semibold text-sm hover:bg-red-100 transition-colors"
                    >
                ...
                <div className="p-6 space-y-4 overflow-y-auto max-h-[calc(100vh-200px)]">
                  {filterGroups.map((group, index) => (
                    <motion.div
                      ...
                      className="bg-white/60 backdrop-blur-xl border border-white/40 rounded-2xl overflow-hidden shadow-lg"
                    >
                      {/* Group Header */}
                      <button
