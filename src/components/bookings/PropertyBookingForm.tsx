      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-t border-gray-200 pt-6 space-y-4">
                    ...
                    {errors.termsAccepted && (
                      <p className="text-red-500 text-xs ml-8">{errors.termsAccepted}</p>
                    )}
                    ...
                    {errors.cancellationPolicyAccepted && (
                      <p className="text-red-500 text-xs ml-8">{errors.cancellationPolicyAccepted}</p>
                    )}
                  </div>
                </div>
              </motion.div>
          ...
          <div className="flex items-center justify-between mt-6">
            ...
            <button
              onClick={handleNext}
              className="flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:shadow-lg transition-all"
            >
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 sticky top-6">
            ...
            {formData.checkInDate && formData.checkOutDate && (
              <div className="mb-4 pb-4 border-b border-gray-200 text-sm">
                ...
                <p className="text-blue-600 font-bold">{nights} Gece</p>
              </div>
            )}
