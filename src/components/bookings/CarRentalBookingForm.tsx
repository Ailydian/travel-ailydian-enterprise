                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        {errors.licenseIssueDate && (
                          <p className="text-red-500 text-xs mt-1">{errors.licenseIssueDate}</p>
                        )}
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-t border-white/10 pt-6">
                    ...
                    {errors.termsAccepted && (
                      <p className="text-red-500 text-xs mt-1 ml-8">{errors.termsAccepted}</p>
                    )}
                  </div>
                </div>
              </motion.div>
          ...
          <div className="bg-white/5 rounded-2xl shadow-md p-6 sticky top-6">
            ...
            {formData.pickupDate && formData.returnDate && (
              <div className="mb-4 pb-4 border-b border-white/10 text-sm">
                ...
                <p className="text-blue-600 font-bold mt-2">{days} Gün</p>
              </div>
            )}
