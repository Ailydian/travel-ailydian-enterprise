...
const propertyTypes: PropertyTypeOption[] = [
  ...
  },
  {
    value: 'villa',
    label: 'Villa',
    description: 'A luxurious detached house with grounds',
    icon: Castle,
  },
  {
    value: 'cottage',
    label: 'Cottage',
    description: 'A small, cozy house, typically in a rural area',
    icon: TreePine,
  },
  {
    value: 'studio',
    label: 'Studio',
    description: 'A single-room living space with integrated facilities',
    icon: Warehouse,
  },
  {
    value: 'townhouse',
  ...
  },
  {
    value: 'bungalow',
    label: 'Bungalow',
    description: 'A single-story house with a low-pitched roof',
    icon: Hotel,
  },
  {
    value: 'penthouse',
    label: 'Penthouse',
    description: 'A luxury apartment on the top floor',
    icon: Crown,
  },
  {
    value: 'houseboat',
  ...
  },
  {
    value: 'other',
    label: 'Other',
    description: 'A unique property type',
    icon: HelpCircle,
  },
];
