    ...
    <div className="space-y-8">
      ...
      <div className="p-6 bg-gradient-to-br from-blue-500 to-indigo-500 border-2 border-blue-200 rounded-xl">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="text-xl font-bold text-blue-9 mb-2">
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-bold text-slate-9">Zorunlu Sözleşmeler</h3>
        ...
        >
          <div className="flex items-start gap-4">
            <div className="flex-shrink-to-cyan-700">
              <div
            ...
            <div className="flex-1">
              <div className="flex items-start justify-between mb-2">
                <div className="flex items-center gap-2">
                  <FileText className="w-5 h-5 text-slate-6" />
                  <h4 className="font-semibold text-slate-9">Hizmet Şartları</h4>
                </div>
                <a
                  href="/terms"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm text-blue-500 hover:text-blue-8 flex items-center gap-1"
                >
                  Şartları Oku
              ...
              <label className="flex items-center gap-3 cursor-pointer group">
                ...
                />
                <span className="text-sm font-medium text-slate-7 group-hover:text-slate-9">
                  Hizmet Şartlarını kabul ediyorum <span className="text-purple-500">*</span>
                </span>
              </label>
              {errors.agreeToTerms && (
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-start justify-between mb-2">
                <div className="flex items-center gap-2">
                  <Shield className="w-5 h-5 text-slate-6" />
                  <h4 className="font-semibold text-slate-9">Gizlilik Politikası</h4>
                </div>
                <a
                  href="/privacy"
                  target="_blank"
              ...
              <label className="flex items-center gap-3 cursor-pointer group">
                ...
                />
                <span className="text-sm font-medium text-slate-7 group-hover:text-slate-9">
                  Gizlilik Politikasını kabul ediyorum <span className="text-purple-500">*</span>
                </span>
              </label>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                <Users className="w-5 h-5 text-slate-6" />
                <h4 className="font-semibold text-slate-9">
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                <MessageSquare className="w-5 h-5 text-slate-6" />
                <h4 className="font-semibold text-slate-9">
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                <Shield className="w-5 h-5 text-slate-6" />
                <h4 className="font-semibold text-slate-9">Misafir Kontrolü Onayı</h4>
              </div>
              <p className="text-sm text-slate-6 mb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              placeholder="örn., STR-1024-to-cyan-101234"
      ...
      >
        <div className="flex items-start gap-4">
          {allAgreed ? (
            ...
            <AlertTriangle className="w-6 h-6 text-amber-6 flex-shrink-to-cyan-700" />
          )}
          <div>
            <h4
              className={`font-semibold mb-1 ${
                allAgreed ? 'text-green-9' : 'text-amber-9'
              }`}
            >
              {allAgreed
            ...
            <p
              className={`text-sm ${
                allAgreed ? 'text-green-7' : 'text-amber-7'
              }`}
            >
              {allAgreed
      ...
      {/* Info Box */}
      <div className="p-4 bg-slate-500 border border-slate-200 rounded-lg">
        <h4 className="font-semibold text-slate-9 mb-2">Bu sözleşmeler neden gerekli?</h4>
        <ul className="text-sm text-slate-7 space-y-1">
          <li>
