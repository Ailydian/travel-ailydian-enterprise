...
const FROM_EMAIL = process.env.EMAIL_FROM || 'noreply@holiday.ailydian.com';
const COMPANY_NAME = 'Holiday.AILYDIAN';
...
export async function sendWelcomeEmail(to: string, name: string): Promise<boolean> {
  const html = `
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <h2>Holiday.AILYDIAN'a Hoş Geldiniz</h2>
          <p>Merhaba ${name},</p>
          ...
          <a href="https://holiday.ailydian.com/destinations" class="button">Destinasyonları Keşfet</a>
  ...
  return await sendEmail({
    to,
    subject: `${name}, Holiday.AILYDIAN'a Hoş Geldiniz! 🎉`,
    html,
  });
}
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <a href="https://holiday.ailydian.com/profile/bookings" class="button">Rezervasyonlarım</a>
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <a href="https://holiday.ailydian.com/profile/transfers" class="button">Transferlerim</a>
        </div>
        <div class="footer">
...
export async function sendPasswordResetEmail(to: string, resetToken: string, name: string): Promise<boolean> {
  const resetUrl = `https://holiday.ailydian.com/auth/reset-password?token=${resetToken}`;
