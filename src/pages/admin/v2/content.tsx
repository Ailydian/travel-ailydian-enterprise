...
import {
  ...
  CheckCircle, Upload, Copy, ExternalLink, Code
} from 'lucide-react';
  ...
  return (
    <div className="bg-white/5 rounded-xl shadow-sm p-6">
      ...
      <div className="space-y-6">
        <div>
          <h3 className="font-semibold text-slate-900 mb-3">Header Menüsü</h3>
        ...
        <div>
          <h3 className="font-semibold text-slate-900 mb-3">Footer Menüsü</h3>
          <div className="bg-slate-50 rounded-lg p-4">
            <pre className="text-sm overflow-x-auto">
      ...
      <div className="space-y-4">
        {data && data.map((section: any, index: number) => (
          <div key={index} className="border border-slate-200 rounded-lg p-4">
            ...
            <p className="text-sm text-slate-600">Tip: {section.type}</p>
          </div>
        ))}
      </div>
    </div>
