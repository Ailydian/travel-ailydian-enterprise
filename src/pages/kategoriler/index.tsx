        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <motion.div
              ...
              className="group bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all cursor-pointer">

                {/* Image */}
                <div className="relative h-48 overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-purple-600/80 to-purple-600/80 group-hover:from-purple-600/70 group-hover:to-purple-600/70 transition-all"></div>
                ...
                <div className="absolute top-3 right-3 bg-green-600 text-white text-xs font-bold px-3 py-1 rounded-full flex items-center gap-1">
                ...
                <div className="p-6">
                  ...
                  <div className="mb-4">
                    ...
                    <span
                      key={dest}
                      className="text-xs bg-white/10 backdrop-blur-xl border border-white/20 text-gray-300 px-2 py-1 rounded-full">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-xs text-gray-400">Ortalama Fiyat:</span>
          ...
          <motion.div
            ...
            className="mt-16 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl rounded-xl shadow-md p-8">
          ...
          {/* SEO Content */}
          <div className="mt-12 bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl p-8">
