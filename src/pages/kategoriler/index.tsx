...
import {
  ...
  type TurkeyCategory } from
'@/lib/turkeyCategories';
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-lydian-glass-dark">
        {/* Hero Section */}
        <div className="relative bg-gradient-to-br from-lydian-secondary via-purple-700 to-indigo-800 text-lydian-text-inverse">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <motion.div
              ...
              <div className="inline-flex items-center gap-2 bg-lydian-glass-dark-heavy backdrop-blur-sm px-4 py-2 rounded-full mb-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="flex items-center gap-3 mb-8">
            <Filter className="h-5 w-5 text-lydian-text-dim" />
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <motion.div
              ...
              className="group bg-lydian-bg-hover rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all cursor-pointer">

                {/* Image */}
                <div className="relative h-48 overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-lydian-secondary/80 to-lydian-primary/80 group-hover:from-lydian-secondary/70 group-hover:to-lydian-primary/70 transition-all"></div>
                ...
                <div className="absolute top-3 right-3 bg-green-500 text-lydian-text-inverse text-xs font-bold px-3 py-1 rounded-full flex items-center gap-1">
                ...
                {/* Content */}
                <div className="p-6">
                  <h3 className="text-xl font-bold text-lydian-text-inverse mb-2 group-hover:text-purple-600 transition-colors">
                    {category.name}
                  </h3>
                  ...
                  <div className="mb-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs font-semibold text-lydian-text-muted">
                    ...
                    <span
                      key={dest}
                      className="text-xs bg-lydian-glass-dark-medium text-lydian-text-muted px-2 py-1 rounded-full">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-xs text-lydian-text-dim">Ortalama Fiyat:</span>
                  ...
                  {/* Features */}
                  <div className="flex items-center gap-2 text-xs text-lydian-text-dim mb-4">
                  ...
                  {/* CTA Button */}
                  <button className="w-full flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 text-lydian-text-inverse font-medium py-3 px-4 rounded-lg transition-colors group-hover:shadow-lg">
                    <span>İncele</span>
          ...
          <motion.div
            ...
            className="mt-16 bg-lydian-bg-hover rounded-xl shadow-md p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="font-bold text-lydian-text-inverse mb-2">
                  Türkiye'ye Özel
                </h3>
              ...
              <div className="text-center">
                <div className="w-16 h-16 bg-lydian-primary-light rounded-full flex items-center justify-center mx-auto mb-4">
                  <MapPin className="h-8 w-8 text-lydian-primary" />
                </div>
                <h3 className="font-bold text-lydian-text-inverse mb-2">Yerel Uzmanlık</h3>
                <p className="text-sm text-lydian-text-dim">
              ...
              <div className="text-center">
                <div className="w-16 h-16 bg-lydian-success-light rounded-full flex items-center justify-center mx-auto mb-4">
                  <TrendingUp className="h-8 w-8 text-lydian-success" />
                </div>
                <h3 className="font-bold text-lydian-text-inverse mb-2">
          ...
          {/* SEO Content */}
          <div className="mt-12 bg-lydian-glass-dark-medium rounded-xl p-8">
            <h2 className="text-2xl font-bold text-lydian-text-inverse mb-4">
              Türkiye'nin Benzersiz Tatil Deneyimleri
            </h2>

            <div className="prose max-w-none text-lydian-text-muted">
              <p>
