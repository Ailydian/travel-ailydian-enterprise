      ...
      <main className="min-h-screen bg-white/5">
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <div className="bg-transparent rounded-2xl shadow-lg p-8 space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">1. Hizmet Koşulları</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">2. Kullanıcı Yükümlülükleri</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">3. Rezervasyon ve İptal Koşulları</h2>
              <p className="text-gray-200 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">5. AI ve VR Hizmetleri</h2>
              <p className="text-gray-200 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">8. Uyuşmazlıkların Çözümü</h2>
              <p className="text-gray-200 leading-relaxed">
