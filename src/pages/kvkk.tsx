  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-slate-900 via-black to-slate-800">
        {/* Hero Section */}
        <div className="bg-gradient-to-r from-blue-600 to-lydian-dark text-white py-16">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Verileriniz 256-bit SSL ile korunur</p>
                </div>
              </div>

              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-green-600-light rounded-lg flex items-center justify-center flex-shrink-0">
                  <UserCheck className="w-6 h-6 text-green-500" />
                </div>
                <div>
                  <h3 className="font-semibold text-white mb-1">Şeffaf Süreç</h3>
                  <p className="text-sm text-gray-400">Ne, neden, nasıl işlendiğini bilirsiniz</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400">Verileriniz üzerinde tam kontrole sahipsiniz</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 pb-16">
          {/* Introduction */}
          <section className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl rounded-lg shadow-md p-8 mb-8">
          ...
          <section className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl rounded-lg shadow-md p-8 mb-8">
            ...
            <div className="space-y-4 text-gray-300">
              <div className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full flex items-center justify-center text-sm font-bold">1</span>
                <p>Seyahat ve konaklama rezervasyonlarınızın alınması, işlenmesi ve yerine getirilmesi</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full flex items-center justify-center text-sm font-bold">2</span>
                <p>Müşteri hizmetleri ve destek süreçlerinin yürütülmesi</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full flex items-center justify-center text-sm font-bold">3</span>
                <p>Ödeme ve fatura işlemlerinin gerçekleştirilmesi</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full flex items-center justify-center text-sm font-bold">4</span>
                <p>Yasal yükümlülüklerin yerine getirilmesi (vergi, ticaret kanunları vb.)</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full flex items-center justify-center text-sm font-bold">5</span>
                <p>Kullanıcı deneyiminin iyileştirilmesi ve kişiselleştirilmiş hizmet sunulması</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full flex items-center justify-center text-sm font-bold">6</span>
                <p>Pazarlama ve reklam faaliyetlerinin yürütülmesi (onayınız dahilinde)</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full flex items-center justify-center text-sm font-bold">7</span>
                <p>Platform güvenliğinin sağlanması ve dolandırıcılığın önlenmesi</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full flex items-center justify-center text-sm font-bold">8</span>
          ...
          <section className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl rounded-lg shadow-md p-8 mb-8">
            ...
            <div className="mt-6 bg-blue-500/10er border border-blue-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
          ...
          <section className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl rounded-lg shadow-md p-8 mb-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 p-4 bg-gradient-to-br from-slate-900 via-black to-slate-800 rounded-lg">
                <Eye className="w-5 h-5 text-blue-500 flex-shrink-0 mt-0.5" />
                <div>
                  <h3 className="font-semibold text-white mb-1">Bilgi Alma Hakkı</h3>
                  <p className="text-sm text-gray-300">Kişisel verilerinizin işlenip işlenmediğini öğrenme ve işlenmişse buna ilişkin bilgi talep etme</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 bg-gradient-to-br from-slate-900 via-black to-slate-800 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">İşlenme amacını ve bunların amacına uygun kullanılıp kullanılmadığını öğrenme, yurt içi/yurt dışı aktarım bilgilerini talep etme</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 bg-gradient-to-br from-slate-900 via-black to-slate-800 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">Eksik veya yanlış işlenmiş kişisel verilerinizin düzeltilmesini talep etme</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 bg-gradient-to-br from-slate-900 via-black to-slate-800 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">Kişisel verilerinizin silinmesini veya yok edilmesini talep etme (yasal saklama yükümlülükleri saklı kalmak kaydıyla)</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 bg-gradient-to-br from-slate-900 via-black to-slate-800 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">Otomatik sistemler ile analiz edilmesi sonucunda aleyhinize bir sonuç doğması halinde itiraz etme</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 bg-gradient-to-br from-slate-900 via-black to-slate-800 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">KVKK&apos;ya aykırılık halinde Kişisel Verileri Koruma Kurulu&apos;na şikayette bulunma</p>
                </div>
              </div>
            </div>
          </section>
          ...
          {/* Contact for Rights */}
          <section className="bg-gradient-to-r from-blue-600 to-lydian-dark text-white rounded-lg p-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 bg-white/10 backdrop-blur-xl border border-white/20 backdrop-blur rounded-lg p-4">
                <Mail className="w-5 h-5 flex-shrink-0 mt-0.5" />
                <div>
                  <p className="font-semibold mb-1">E-posta</p>
                  <a href="mailto:kvkk@holiday.ailydian.com" className="text-blue-100 hover:text-white">
            ...
            <div className="mt-6 p-4 bg-white/10 backdrop-blur-xl border border-white/20 backdrop-blur rounded-lg">
