                    ...
                    <div className="flex flex-col items-center">
                      <motion.div
                        ...
                        animate={{
                          ...
                          backgroundColor: isCompleted ? 'var(--lydian-success)' : isActive ? 'var(--lydian-accent-purple)' : 'var(--lydian-border)'
                        }}
                  ...
                  <div>
                      ...
                      <div className="space-y-4 mb-6">
                        ...
                        <div className="bg-lydian-error-lighter rounded-xl p-4 border border-red-200">
                          ...
                          <ul className="space-y-1 text-sm text-lydian-primary-active">
