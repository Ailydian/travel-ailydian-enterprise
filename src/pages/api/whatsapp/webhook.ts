...
async function handleInteractiveResponse(customerPhone: string, selectedId: string): Promise<void> {
  ...
  switch (selectedId) {
    case 'booking':
      response = '🎫 Rezervasyon yapmak için lütfen holiday.ailydian.com adresini ziyaret edin.\n\nVeya hangi hizmeti arıyorsunuz?\n\n🏨 Otel\n🚗 Araç\n🎭 Tur\n🚕 Transfer';
      break;
