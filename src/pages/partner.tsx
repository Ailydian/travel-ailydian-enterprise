  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-50">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-br from-lydian-primary via-lydian-primary to-lydian-secondary py-20 overflow-hidden">
          {/* Animated Background */}
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-10 left-10 w-96 h-96 bg-lydian-bg-hover rounded-full blur-3xl animate-pulse" />
            <div className="absolute bottom-10 right-10 w-96 h-96 bg-lydian-bg-hover rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <motion.div
              ...
              <p className="text-xl md:text-2xl text-lydian-text-inverse/90 mb-8 max-w-3xl mx-auto">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center gap-2 px-8 py-4 bg-lydian-bg-hover text-lydian-primary rounded-xl font-bold text-lg shadow-2xl hover:shadow-white/20 transition-all">
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center gap-2 px-8 py-4 bg-lydian-glass-dark-medium backdrop-blur-md text-lydian-text-inverse border-2 border-lydian-border-light rounded-xl font-bold text-lg hover:bg-lydian-glass-dark-heavy transition-all">
              ...
              {partnerTypes.map((type, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="bg-lydian-bg-hover rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all border border-lydian-border-light">

                    <div className={`inline-flex p-4 rounded-xl bg-gradient-to-br ${type.color} text-lydian-text-inverse mb-6`}>
                      <Icon className="w-8 h-8" />
                    </div>
                    <h3 className="text-2xl font-bold text-lydian-text-inverse mb-3">{type.title}</h3>
                    <p className="text-lydian-text-dim mb-6">{type.description}</p>
                    <div className="space-y-2">
                      {type.benefits.map((benefit, idx) =>
                      <div key={idx} className="flex items-center gap-2 text-sm text-lydian-text-muted">
              ...
              {benefits.map((benefit, index) => {
                ...
                return (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: index * 0.1 }}
                    className="relative bg-lydian-bg-hover rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all">
                    ...
                    <h3 className="text-xl font-bold text-lydian-text-inverse mb-2">{benefit.title}</h3>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="bg-lydian-bg-hover rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all">
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-4 text-lydian-text-inverse">
                      <h3 className="text-xl font-bold">{story.name}</h3>
                      <p className="text-sm text-lydian-text-inverse/80">{story.type}</p>
                    </div>
                  </div>
                  <div className="p-6">
                    <p className="text-lydian-text-muted italic mb-4">"{story.quote}"</p>
                    <div className="flex items-center justify-between pt-4 border-t border-lydian-border-light">
                      ...
                      <div className="text-lydian-text-dim text-sm">{story.stat}</div>
                    </div>
                  </div>
                </motion.div>
              )}
        ...
        <section id="basvuru" className="py-20 bg-gradient-to-b from-gray-50 to-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="bg-lydian-bg-hover rounded-2xl shadow-xl p-8">

              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-bold text-lydian-text-muted mb-2">
                      Şirket Adı *
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full px-4 py-3 border-2 border-lydian-border rounded-xl focus:ring-2 focus:ring-lydian-primary focus:border-lydian-border transition-all"
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-lydian-primary to-lydian-secondary text-lydian-text-inverse rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all">

                  <Send className="w-5 h-5" />
                  Başvuruyu Gönder
                </motion.button>

                <p className="text-center text-sm text-lydian-text-muted">
        ...
        <section className="py-12 bg-gradient-to-r from-lydian-primary to-lydian-secondary">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-lydian-text-inverse text-center">
              <div className="flex flex-col items-center gap-3">
                <Mail className="w-8 h-8" />
                <div>
                  <div className="font-bold mb-1">E-posta</div>
                  <a href="mailto:partners@lydian.com" className="text-lydian-text-inverse/90 hover:text-lydian-text-inverse">
                    partners@lydian.com
                  </a>
                </div>
              </div>
              <div className="flex flex-col items-center gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+908501234567" className="text-lydian-text-inverse/90 hover:text-lydian-text-inverse">
                    0850 123 45 67
                  </a>
                </div>
              </div>
              <div className="flex flex-col items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-lydian-text-inverse/90">
                    Antalya, Türkiye
                  </p>
                </div>
              </div>
