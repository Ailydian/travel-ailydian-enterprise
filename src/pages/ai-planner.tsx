  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-lydian-glass-dark">
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-lydian-primary via-lydian-secondary to-lydian-primary-darker py-20">
            ...
            <motion.div
              ...
              <div className="flex items-center justify-center gap-3 mb-6">
                <div className="p-3 bg-lydian-glass-dark-medium backdrop-blur-sm rounded-2xl">
                  <Brain className="w-8 h-8 text-lydian-text-inverse" />
                </div>
        ...
        <section className="py-16">
          <div className="max-w-4xl mx-auto px-4">
            <div className="bg-lydian-bg-hover rounded-3xl shadow-2xl overflow-hidden">
              {/* Progress Bar */}
              <div className="bg-lydian-glass-dark px-8 py-6 border-b">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-2xl font-bold text-lydian-text-inverse">
                    AI ile Kişisel Seyahat Planı Oluştur
                  </h2>
                  <span className="text-sm text-lydian-text-dim">Adım {step}/4</span>
                </div>
              ...
              <div className="p-8">
                ...
                <motion.div
                  ...
                  className="space-y-6">
                    ...
                    <div className="text-center mb-8">
                      <MapPin className="w-12 h-12 text-lydian-primary mx-auto mb-4" />
                      <h3 className="text-2xl font-bold mb-2">Nereye gitmek istiyorsunuz?</h3>
                      <p className="text-lydian-text-dim">Temel bilgileri verin, AI size en uygun planı oluştursun.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        className="w-full px-4 py-3 border border-lydian-border-medium rounded-xl focus:ring-2 focus:ring-lydian-border-focus outline-none" />
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          className="p-2 border border-lydian-border-medium rounded-lg hover:bg-lydian-glass-dark">
                ...
                <motion.div
                  ...
                  className="space-y-6">
                    ...
                    <div className="text-center mb-8">
                      ...
                      <p className="text-lydian-text-dim">Hangi aktiviteler sizi heyecanlandırıyor?</p>
                    </div>
                ...
                <motion.div
                  ...
                  className="space-y-6">
                    ...
                    <div className="text-center mb-8">
                      ...
                      <p className="text-lydian-text-dim">Nasıl bir deneyim yaşamak istiyorsunuz?</p>
                    </div>
                    ...
                    <button
                      ...
                      'border-gray-200 hover:border-gray-300'}`
                          ...
                          <p className="text-lydian-text-dim">{style.desc}</p>
                        </button>
                    )}
                    </div>
                  </motion.div>
                ...
                <motion.div
                  ...
                  className="space-y-6">
                    ...
                    <div className="text-center mb-8">
                      <Bot className="w-12 h-12 text-lydian-success mx-auto mb-4" />
                      <h3 className="text-2xl font-bold mb-2">AI Planınız Hazırlanıyor</h3>
                      <p className="text-lydian-text-dim">Son bir kontrol yapalım ve AI size mükemmel planı oluştursun!</p>
                    </div>

                    <div className="bg-lydian-glass-dark rounded-2xl p-6">
                    ...
                    <div className="text-center">
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="px-8 py-4 bg-gradient-to-r from-lydian-success to-lydian-primary text-lydian-text-inverse rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all flex items-center gap-3 mx-auto">
                ...
                <div className="flex justify-between mt-12 pt-6 border-t">
                  <button
                    ...
                    disabled={step === 1}
                    className="px-6 py-3 border border-lydian-border-medium rounded-xl text-lydian-text-muted hover:bg-lydian-glass-dark disabled:opacity-50 disabled:cursor-not-allowed">
                  ...
                  <button
                    ...
                    disabled={step === 4}
                    className="px-6 py-3 bg-lydian-primary text-lydian-text-inverse rounded-xl hover:bg-lydian-primary-dark disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2">
        ...
        <section className="py-16 bg-lydian-glass-dark">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-lydian-text-inverse mb-4">AI Planlama Avantajları</h2>
              <p className="text-lydian-text-dim">Neden AI ile seyahat planlamak daha iyi?</p>
            </div>
