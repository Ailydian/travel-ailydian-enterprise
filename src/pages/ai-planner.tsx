                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-4">
                            <motion.button
                              ...
                              className="p-3 bg-white/5 dark:bg-white/5 border border-white/10 rounded-xl hover:bg-lydian-bg/10 transition-all backdrop-blur-xl"
                            >
                            ...
                            <motion.button
                              ...
                              className={`relative p-4 rounded-2xl border-2 transition-all text-sm font-semibold overflow-hidden ${
                                isSelected
                                  ...
                                  : 'border-white/10 bg-white/5 text-gray-300 hover:border-white/20 hover:bg-lydian-bg/10'
                              }`}
                            >
                              {isSelected && (
                                <motion.div
                            ...
                            <motion.button
                              ...
                              className={`relative p-8 rounded-3xl border-2 transition-all text-left overflow-hidden group ${
                                isSelected
                                  ...
                                  : 'border-white/10 bg-white/5 hover:border-white/20 hover:bg-lydian-bg/10'
                              }`}
                            >
                              {/* Background gradient */}
                              {isSelected && (
                              ...
                              <div className="relative z-10">
                                ...
                                <p className="text-gray-300 leading-relaxed">{style.desc}</p>
                              </div>
                            </motion.button>
                          );
                        })}
                      ...
                      <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              <p className="text-sm text-gray-300">Destinasyon</p>
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              <p className="text-sm text-gray-300">Süre</p>
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              <p className="text-sm text-gray-300">Kişi Sayısı</p>
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              <p className="text-sm text-gray-300">Bütçe</p>
                          ...
                          <div className="flex items-start gap-3 md:col-span-2">
                            ...
                            <div>
                              <p className="text-sm text-gray-300">İlgi Alanları</p>
                          ...
                          <div className="flex items-start gap-3 md:col-span-2">
                            ...
                            <div>
                              <p className="text-sm text-gray-300">Seyahat Tarzı</p>
                              <p className="font-semibold text-white">
