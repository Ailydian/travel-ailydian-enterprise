        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <div className="relative">
              <div className="grid grid-cols-3 gap-4 items-center">
                ...
                <div className="text-left">
                  ...
                  <div className="text-lg font-semibold text-gray-700">{flight.from.code}</div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <h3 className="text-sm font-semibold text-gray-700 mb-3">Uçuş İmkanları</h3>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              >
                <h2 className="text-xl font-bold text-gray-900 mb-6">Ücret Sınıfı Seçin</h2>
                <div className="grid md:grid-cols-3 gap-4">
                  {flight.fareClasses.map((fare: any) => (
                    ...
                    >
                      ...
                      <h3 className="font-bold text-lg text-gray-900 mb-2">{fare.name}</h3>
                      {fare.originalPrice && (
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-4 rounded-xl">
                    <h3 className="font-semibold text-gray-900 mb-2">Kontrol Edilen Bagaj</h3>
                    <p className="text-2xl font-bold text-green-600 mb-1">{flight.baggage.checked}</p>
                    <p className="text-sm text-gray-600">Ücret sınıfına göre değişir</p>
                  </div>
                </div>
              ...
              <motion.div
                ...
                className="bg-white rounded-2xl shadow-lg p-6"
              >
                <h2 className="text-xl font-bold text-gray-900 mb-4">İptal Politikası</h2>
            ...
            <div className="lg:col-span-1">
              ...
              >
                <h2 className="text-xl font-bold text-gray-900 mb-6">Rezervasyon Özeti</h2>
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-700">Yetişkin (12+)</span>
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-700">Çocuk (2-11)</span>
                      <div className="flex items-center gap-3">
                        <button
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-700">Bebek (0-2)</span>
                      <div className="flex items-center gap-3">
                        <button
                ...
                <div className="border-t border-gray-200 pt-4 mb-6">
                  <h3 className="font-semibold text-gray-900 mb-3">Fiyat Detayı</h3>
                  <div className="space-y-2 text-sm">
                    {passengers.adults > 0 && (
                      <div className="flex justify-between">
                        <span className="text-gray-600">{passengers.adults} Yetişkin x ₺{selectedFare?.price}</span>
                        <span className="font-semibold">₺{passengers.adults * (selectedFare?.price || 0)}</span>
                      </div>
                    )}
                    {passengers.children > 0 && (
                      <div className="flex justify-between">
                        <span className="text-gray-600">{passengers.children} Çocuk x ₺{selectedFare?.price}</span>
                        <span className="font-semibold">₺{passengers.children * (selectedFare?.price || 0)}</span>
                      </div>
                    )}
                    {passengers.infants > 0 && (
                      <div className="flex justify-between">
                        <span className="text-gray-600">{passengers.infants} Bebek x ₺50</span>
