...
export default function FlightBooking() {
  ...
  const validateStep = (step: number): boolean => {
    ...
    if (step === 2) {
      ...
      if (!leadPassenger.email) newErrors['leadPassenger-email'] = 'E-posta gerekli';else
      if (!/\S+@\S+\.\S+/.test(leadPassenger.email)) newErrors['leadPassenger-email'] = 'Geçersiz e-posta';
                ...
                <motion.div
                  ...
                  className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl rounded-2xl shadow-lg p-6">
                    ...
                    <div key={idx} className="border-2 border-white/20/10 rounded-xl p-6">
                          ...
                          <p className="mt-1 text-sm text-lydian-error">{errors[`passenger-${idx}-title`]}</p>
                          }
                            </div>
                          ...
                          <p className="mt-1 text-sm text-lydian-error">{errors[`passenger-${idx}-firstName`]}</p>
                          }
                            </div>
                          ...
                          <p className="mt-1 text-sm text-lydian-error">{errors[`passenger-${idx}-lastName`]}</p>
                          }
                            </div>
                          ...
                          <p className="mt-1 text-sm text-lydian-error">{errors[`passenger-${idx}-dateOfBirth`]}</p>
                          }
                            </div>
                      ...
                      <div className="border-2 border-blue-200 rounded-xl p-6 bg-blue-500/10er">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          ...
                          <p className="mt-1 text-sm text-lydian-error">{errors['leadPassenger-email']}</p>
                          }
                          </div>
                          ...
                          <p className="mt-1 text-sm text-lydian-error">{errors['leadPassenger-phone']}</p>
                          }
                          </div>
                        </div>
                      </div>
                  ...
                  className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl rounded-2xl shadow-lg p-6">
                    ...
                    <div className="mb-6">
                      <div className="flex items-center gap-4 text-sm">
                        ...
                        <div className="flex items-center gap-2">
                          <div className="w-8 h-8 bg-green-200 border-2 border-lydian-success rounded"></div>
                ...
                <motion.div
                  ...
                  <div className="mb-6 p-4 bg-green-600-lighter rounded-lg">
                    ...
                    <div className="mb-6">
                      ...
                      {errors.terms &&
                    <p className="mt-2 text-sm text-lydian-error flex items-center gap-1">
