        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold mb-2 text-lydian-text-inverse">
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  <div className="text-2xl font-bold text-lydian-text-inverse">{stat.value}</div>
                  <div className="text-sm text-lydian-text-dim">{stat.label}</div>
                </motion.div>
              );
            })}
          </motion.div>
          ...
          >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {upcomingBookings.map((booking) => (
                      ...
                      >
                        ...
                        <div className="p-4">
                          <h3 className="font-bold mb-2 text-lydian-text-inverse">{booking.title}</h3>
                          <div className="flex items-center gap-2 text-sm mb-2 text-lydian-text-dim">
                            <MapPin className="w-4 h-4" />
                            {booking.location}
                          </div>
                          <div className="flex items-center gap-2 text-sm mb-3 text-lydian-text-dim">
                      ...
                      >
                        <div className="flex">
                          ...
                          <div className="w-2/3 p-4">
                            <h3 className="font-bold mb-1 text-lydian-text-inverse">{rec.title}</h3>
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm text-lydian-text-dim">{rec.rating}</span>
                              </div>
                              <span className="font-bold text-lydian-text-inverse">{rec.price}</span>
                            </div>
                          </div>
                        </div>
                      </motion.div>
            ...
            {activeTab === 'bookings' && (
              <div>
                <h2 className="text-2xl font-bold mb-6 text-lydian-text-inverse">Tüm Rezervasyonlar</h2>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <h3 className="font-bold text-lydian-text-inverse">{booking.title}</h3>
                            <p className="text-sm text-lydian-text-dim">{booking.location}</p>
            ...
            {activeTab === 'trips' && (
              <div>
                <h2 className="text-2xl font-bold mb-6 text-lydian-text-inverse">Geçmiş Seyahatler</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {recentTrips.map((trip) => (
                    ...
                    >
                      ...
                      <div className="p-4">
                        <h3 className="font-bold text-lg mb-2 text-lydian-text-inverse">
                          {trip.destination}
                        </h3>
                        <div className="flex items-center justify-between text-sm mb-3 text-lydian-text-dim">
            ...
            {activeTab === 'profile' && (
              <div>
                <h2 className="text-2xl font-bold mb-6 text-lydian-text-inverse">Profil Ayarları</h2>
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="lg:col-span-1">
                    <div className="rounded-2xl p-6 text-center bg-lydian-bg/5 backdrop-blur-xl border border-white/10">
                      ...
                      <h3 className="text-xl font-bold mb-2 text-lydian-text-inverse">{userData.name}</h3>
                      <p className="text-lydian-text-dim">{userData.level}</p>
                  ...
                  <div className="lg:col-span-2">
                    <div className="rounded-2xl p-6 bg-lydian-bg/5 backdrop-blur-xl border border-white/10">
                      <form className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div>
                            <label className="block text-sm font-medium mb-2 text-lydian-text-dim">Ad</label>
                            <input
                              type="text"
                              defaultValue="Ahmet"
                          ...
                          <div>
                            <label className="block text-sm font-medium mb-2 text-lydian-text-dim">
                              Soyad
                            </label>
                            <input
                              type="text"
                        ...
                        <div>
                          <label className="block text-sm font-medium mb-2 text-lydian-text-dim">E-posta</label>
                          <input
                            type="email"
                        ...
                        <div>
                          <label className="block text-sm font-medium mb-2 text-lydian-text-dim">Telefon</label>
                          <input
                            type="tel"
