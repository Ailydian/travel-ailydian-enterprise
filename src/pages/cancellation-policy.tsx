          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl rounded-xl shadow-xl p-8">
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center p-4">
                ...
                <p className="text-gray-400">24 saat içinde ücretsiz iptal hakkı</p>
              </div>
              ...
              <div className="text-center p-4">
                ...
                <p className="text-gray-400">5-10 iş günü içinde iade işlemi</p>
              </div>
              ...
              <div className="text-center p-4">
                ...
                <p className="text-gray-400">İptal sürecinizde yardım</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  ...
                  className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl text-blue-500 px-6 py-3 rounded-lg font-semibold hover:bg-blue-500/10er transition-colors inline-flex items-center justify-center gap-2">
                ...
                <a
                  href="/manage-booking"
                  className="bg-white/10 backdrop-blur-xl border border-white/20 backdrop-blur text-white border-2 border-white/20 px-6 py-3 rounded-lg font-semibold hover:bg-white/10 backdrop-blur-xl border border-white/20 transition-colors inline-flex items-center justify-center gap-2">
