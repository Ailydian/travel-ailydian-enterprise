      ...
      <main className="min-h-screen bg-gradient-to-br from-slate-900 via-black to-slate-800">
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl rounded-xl shadow-xl p-8">
            ...
            <form onSubmit={handleSearch}>
              ...
              <div className="space-y-6">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      className="w-full pl-11 pr-4 py-3 border border-white/30 rounded-lg focus:ring-2 focus:ring-lydian-primary focus:border-white/20"
                      required />
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full mt-8 bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 rounded-lg font-semibold hover:bg-lydian-dark transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2">
        ...
        <div className="max-w-7xl mx-auto px-4 py-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 bg-green-600-light rounded-full flex items-center justify-center mb-4">
        ...
        {/* Help Section */}
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl border-t border-white/20 py-12">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <a href="tel:+908505551234" className="text-blue-500 font-semibold hover:underline">
                  0850 555 12 34
                </a>
              </div>
              ...
              <div className="text-center">
                ...
                <a href="mailto:destek@holiday.ailydian.com" className="text-blue-500 font-semibold hover:underline">
              ...
              <div className="text-center">
                ...
                <a href="/faq" className="text-blue-500 font-semibold hover:underline">
                  Yardım Merkezi
                </a>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <div className="bg-blue-500/10er border border-blue-200 rounded-lg p-6">
            <div className="flex items-start gap-3">
              <AlertCircle className="w-6 h-6 text-blue-500 flex-shrink-0 mt-0.5" />
              <div>
                <h3 className="font-semibold text-white mb-2">Önemli Bilgiler</h3>
