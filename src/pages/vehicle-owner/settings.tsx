  ...
  return (
    <div className="min-h-screen bg-lydian-glass-dark p-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Tabs */}
        <div className="bg-lydian-bg-hover rounded-2xl border-2 shadow-sm mb-6" style={{ borderColor: '#E5E7EB' }}>
        ...
        {/* Tab Content */}
        <div className="bg-lydian-bg-hover rounded-2xl border-2 shadow-sm p-8" style={{ borderColor: '#E5E7EB' }}>
          {/* Account Tab */}
          {activeTab === 'account' &&
              ...
              <div>
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-3">
                    ...
                    return (
                      <div key={day} className="flex items-center gap-4 p-4 rounded-xl border-2" style={{ borderColor: '#E5E7EB' }}>
                          <input
                          type="checkbox"
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 rounded-xl border-2" style={{ borderColor: '#E5E7EB' }}>
                      <div>
              ...
              <div>
                ...
                <div className="mt-6 p-4 rounded-xl" style={{ backgroundColor: 'rgba(5, 150, 105, 0.1)' }}>
                  <div className="flex items-start gap-3">
                    <DollarSign className="w-5 h-5 mt-0.5" style={{ color: '#059669' }} />
                    <div>
                      <p className="font-bold mb-1" style={{ color: '#059669' }}>Ödeme Güvenliği</p>
