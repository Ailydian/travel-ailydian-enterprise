...
export default function VehicleOwnerDashboard() {
  ...
  const COLORS = ['var(--lydian-success-hover)', 'var(--lydian-success)', '#34D399', '#6EE7B7', '#A7F3D0'];
  ...
  { type: 'booking', message: 'Yeni kiralama: BMW 3 Serisi', time: '10 dk önce', icon: Calendar, color: 'var(--lydian-success-hover)' },
  { type: 'review', message: 'Yeni değerlendirme aldınız (5 yıldız)', time: '1 saat önce', icon: Star, color: 'var(--lydian-success)' },
  { type: 'message', message: 'Can Öztürk sizinle iletişime geçti', time: '2 saat önce', icon: MessageSquare, color: 'var(--lydian-success-hover)' },
  { type: 'payment', message: '4,500 TL ödeme alındı', time: '3 saat önce', icon: DollarSign, color: 'var(--lydian-success)' }];
          ...
          <div className="flex gap-4">
            ...
            <Link
              ...
              style={{
                ...
                color: 'var(--lydian-success-hover)',
            ...
            <AreaChart data={revenueData}>
              <defs>
                <linearGradient id="colorGelir" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="var(--lydian-success-hover)" stopOpacity={0.3} />
                  <stop offset="95%" stopColor="var(--lydian-success-hover)" stopOpacity={0} />
                </linearGradient>
              </defs>
              ...
              <Area
                type="monotone"
                dataKey="gelir"
                stroke="var(--lydian-success-hover)"
                strokeWidth={3}
                fillOpacity={1}
                fill="url(#colorGelir)" />
        ...
        style={{
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <Link
              ...
              style={{ color: 'var(--lydian-success-hover)' }}>
              ...
              style={{
                ...
                <div className="flex items-start justify-between mb-3">
                  ...
                  style={{
                    ...
                    color: pickup.status === 'confirmed' ? 'var(--lydian-success)' : 'var(--lydian-warning)'
                  }}>
                ...
                <div className="grid grid-cols-3 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-bold" style={{ color: 'var(--lydian-success-hover)' }}>₺{pickup.amount.toLocaleString('tr-TR')}</p>
                  </div>
                </div>
              </div>
            )}
      ...
      style={{
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr style={{ borderBottom: '2px solid var(--lydian-border)' }}>
