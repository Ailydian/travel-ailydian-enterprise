          ...
          <motion.div
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="h-4 w-4 text-purple-400 focus:ring-green-600 border-white/20 rounded cursor-pointer" />
                ...
                <Link
                  ...
                  className="text-sm font-medium text-purple-400 hover:text-emerald-600 transition-colors">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-lydian-success to-lydian-success text-white py-3 px-4 rounded-lg font-semibold hover:shadow-lg transform hover:scale-[1.02] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-2">
