        ...
        >
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {sections.map((section, index) => (
              ...
              >
                <section.icon className="w-5 h-5 text-green-600 flex-shrink-0" />
                <span className="text-sm font-medium text-white group-hover:text-green-600 transition-colors">
                  {section.title}
                </span>
              </a>
            ))}
            ...
            {accepted ? (
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 px-6 py-4 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-lg font-semibold hover:shadow-lg transform hover:scale-[1.02] transition-all"
                >
