...
const CartPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <Link 
        href="/" 
        className="fixed top-24 left-6 z-40 flex items-center gap-2 px-4 py-2 bg-white/90 backdrop-blur-sm rounded-xl shadow-lg border border-gray-200 text-gray-200 hover:bg-white/5 hover:text-lydian-primary transition-all duration-200"
      >
