  ...
  return (
    <div className="space-y-6">
            ...
            style={{
              ...
              <div className="flex items-start gap-3">
                ...
                style={{
                  ...
                  'linear-gradient(135deg, var(--lydian-success), var(--lydian-success-hover))' :
                  'linear-gradient(135deg, var(--lydian-secondary), var(--lydian-primary))'
                }}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
        { label: 'Toplam Sürücü', value: stats.total, icon: Users, color: 'var(--lydian-info-hover)' },
        { label: 'Görevde', value: stats.onDuty, icon: Activity, color: 'var(--lydian-info-hover)' },
        { label: 'Ortalama Puan', value: stats.avgRating, icon: Star, color: 'var(--lydian-warning)', suffix: '★' },
        { label: 'Toplam Transfer', value: stats.totalTrips, icon: TrendingUp, color: 'var(--lydian-success)' }].
        map((stat, index) =>
        <motion.div
          key={index}
            ...
            <motion.div
              ...
              style={{
                ...
                <div className="pt-14 px-6 pb-6">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex items-center gap-1">
                        <Star className="w-4 h-4" style={{ color: 'var(--lydian-warning)', fill: 'var(--lydian-warning)' }} />
                      ...
                      <span className="text-xs font-medium" style={{ color: 'var(--lydian-success)' }}>
                  ...
                  {/* Contact Info */}
                  <div className="space-y-2 mb-4 pb-4 border-b" style={{ borderColor: 'var(--lydian-border)' }}>
                  ...
                  <div className="mb-4 pb-4 border-b" style={{ borderColor: 'var(--lydian-border)' }}>
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-2">
                        <Shield className="w-4 h-4" style={{ color: 'var(--lydian-info-hover)' }} />
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      color: licenseExpired ? 'var(--lydian-secondary)' : licenseExpiringSoon ? 'var(--lydian-warning)' : '#666666'
                    }} />
                      <span className="text-xs" style={{
                      color: licenseExpired ? 'var(--lydian-secondary)' : licenseExpiringSoon ? '#F59E0B' : '#666666'
                    }}>
        ...
        boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)'
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead style={{ backgroundColor: 'var(--lydian-bg-surface)' }}>
                <tr>
              ...
              <tbody className="divide-y" style={{ borderColor: 'var(--lydian-border)' }}>
              ...
              <form onSubmit={handleAddDriver} className="space-y-4">
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  style={{
                    ...
                    color: 'var(--lydian-text-tertiary)'
                  }}>
            ...
            className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={handleEditDriver} className="space-y-4">
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  className="flex-1 px-6 py-3 rounded-xl font-bold transition-all hover:scale-105"
                  style={{
                    background: 'linear-gradient(135deg, #2563EB, var(--lydian-accent-cyan))',
                    color: 'white'
                  }}>
