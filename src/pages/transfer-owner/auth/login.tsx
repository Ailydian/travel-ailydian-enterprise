...
import { validateTransferOwnerCredentials } from '@/data/mockTransferAuth';

export default function TransferOwnerLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      // Mock authentication
      const owner = validateTransferOwnerCredentials(formData.email, formData.password);
      ...
      if (owner) {
        ...
        localStorage.setItem('transferOwnerAuth', JSON.stringify({
          id: owner.id,
          email: owner.email,
          fullName: owner.fullName,
          phone: owner.phone,
          companyName: owner.companyName,
          tourismLicense: owner.tourismLicense,
          fleetSize: owner.fleetSize,
          activeTransfers: owner.activeTransfers,
          rememberMe: formData.rememberMe
        }));

        // Dashboard'a yönlendir
        setTimeout(() => {
          router.push('/transfer-owner');
        }, 1500);
      } else {
        // Hatalı giriş
        setErrors({
          ...
          <div className="relative z-10">
            ...
            <div>
              ...
              <p className="text-blue-100 text-lg mb-8">
                Binlerce transfer hizmeti sağlayıcısının tercih ettiği platform ile rezervasyonlarınızı yönetin, gelirinizi artırın.
              </p>
