...
export default function FleetManagementPage() {
  ...
  const getStatusColor = (status: VehicleStatus) => {
    switch (status) {
      ...
      case 'in-service':
        return { bg: 'rgba(245, 158, 11, 0.1)', text: '#F59E0B', label: 'Seferde' };
      case 'maintenance':
        return { bg: 'rgba(239, 68, 68, 0.1)', text: '#EF4444', label: 'Bakımda' };
      case 'retired':
        return { bg: 'rgba(107, 114, 128, 0.1)', text: '#6B7280', label: 'Pasif' };
      default:
              ...
              <div className="p-5">
                ...
                <div className="mb-4">
                  <div className="flex items-center gap-2 mb-2">
                    <UserCheck className="w-4 h-4" style={{ color: vehicle.driver.assigned ? '#10B981' : '#666666' }} />
