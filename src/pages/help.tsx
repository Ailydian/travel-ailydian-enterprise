          ...
          >
            {quickHelpTopics.map((topic, index) => (
              <motion.a
                ...
                className="group bg-transparent rounded-2xl shadow-lg hover:shadow-2xl transition-all p-6 cursor-pointer"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
              ...
              <AnimatePresence mode="popLayout">
                {filteredFaqs.map((faq, index) => (
                  <motion.div
                    ...
                    className="bg-transparent rounded-xl shadow-md hover:shadow-xl transition-all overflow-hidden"
                  >
                    <button
                    ...
                    >
                      <div className="flex items-start gap-4 flex-1 pr-4">
                        ...
                        <span className="text-lg font-semibold text-white group-hover:text-lydian-primary transition-colors">
                          {faq.question}
                        </span>
                      </div>
                      <motion.div
                      ...
                      {expandedFaq === faq.id && (
                        ...
                        >
                          <div className="px-6 pb-6 pl-[72px]">
                            <div className="bg-white/5 rounded-lg p-4 border-l-4 border-lydian-primary">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                <div className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-green-500 to-emerald-600 mb-4 group-hover:scale-110 transition-transform">
              ...
              <motion.a
                ...
                className="bg-white/10 backdrop-blur-md border-2 border-white/20 rounded-2xl p-6 hover:bg-white/20 transition-all group text-center"
              >
                <div className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-blue-500 to-cyan-600 mb-4 group-hover:scale-110 transition-transform">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link
              ...
              className="bg-transparent rounded-xl p-6 shadow-md hover:shadow-xl transition-all group"
            >
