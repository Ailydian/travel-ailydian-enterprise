...
const CarRentalBookingPage: React.FC = () => {
  ...
  const validateStep3 = (): boolean => {
    ...
    if (!bookingData.driver.email) newErrors.driverEmail = 'E-posta gereklidir';else
    if (!/\S+@\S+\.\S+/.test(bookingData.driver.email)) newErrors.driverEmail = 'Geçersiz e-posta';
                      ...
                      <div className="border border-lydian-border-light/10 rounded-xl p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="md:col-span-2">
                            ...
                            className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-lydian-border-focus outline-none ${
                      ...
                      <div className="border border-lydian-border-light/10 rounded-xl p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            {errors.returnDate &&
                          <p className="text-sm text-lydian-error mt-1">{errors.returnDate}</p>
                          }
                          </div>
                          <div>
                            <label className="block text-sm font-medium text-lydian-text-muted mb-2">Saat *</label>
                  ...
                  className="bg-lydian-bg-hover rounded-2xl shadow-sm p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        {errors.driverName && <p className="text-sm text-lydian-error mt-1">{errors.driverName}</p>}
                      </div>
                      ...
                      <div>
                        ...
                        {errors.driverEmail && <p className="text-sm text-lydian-error mt-1">{errors.driverEmail}</p>}
                      </div>
                      ...
                      <div>
                        ...
                        {errors.driverPhone && <p className="text-sm text-lydian-error mt-1">{errors.driverPhone}</p>}
                      </div>
                      ...
                      <div>
                        ...
                        {errors.driverAge && <p className="text-sm text-lydian-error mt-1">{errors.driverAge}</p>}
                      </div>
                      ...
                      <div>
                        ...
                        {errors.licenseNumber && <p className="text-sm text-lydian-error mt-1">{errors.licenseNumber}</p>}
                      </div>
                      ...
                      <div>
                        ...
                        {errors.licenseExpiry && <p className="text-sm text-lydian-error mt-1">{errors.licenseExpiry}</p>}
                      </div>
                      ...
                      <div className="md:col-span-2">
                        ...
                        {errors.terms && <p className="text-sm text-lydian-error mt-1">{errors.terms}</p>}
                      </div>
                    </div>
