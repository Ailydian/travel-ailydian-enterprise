      ...
      <main className="min-h-screen bg-white/5">
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <div className="bg-transparent rounded-2xl shadow-lg p-8 space-y-8">
            ...
            <section>
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-blue-500 pl-4">
                  <h3 className="font-bold text-lg text-white mb-2">Gerekli Çerezler</h3>
                  <p className="text-gray-200">Web sitesinin temel işlevleri için zorunlu olan çerezlerdir. Giriş durumu, sepet içeriği ve güvenlik.</p>
                </div>

                <div className="border-l-4 border-green-500 pl-4">
                  <h3 className="font-bold text-lg text-white mb-2">Analitik Çerezler</h3>
                  <p className="text-gray-200">Google Analytics ile site kullanım istatistikleri. Hangi sayfaların popüler olduğunu anlamaya yarar.</p>
                </div>

                <div className="border-l-4 border-purple-500 pl-4">
                  <h3 className="font-bold text-lg text-white mb-2">AI Kişiselleştirme Çerezler</h3>
                  <p className="text-gray-200">Seyahat tercihlerinizi öğrenmek ve size özel AI öneriler sunmak için kullanılır.</p>
                </div>

                <div className="border-l-4 border-orange-500 pl-4">
                  <h3 className="font-bold text-lg text-white mb-2">Pazarlama Çerezler</h3>
                  <p className="text-gray-200">İlgi alanlarınıza uygun reklamlar göstermek için üçüncü taraf platformlarda kullanılır.</p>
                </div>
              </div>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-white mb-4">3. Çerez Yönetimi</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">4. AI ve Blockchain Çerezler</h2>
              <p className="text-gray-200 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">5. Üçüncü Taraf Çerezler</h2>
              <ul className="list-disc list-inside text-gray-200 space-y-2">
