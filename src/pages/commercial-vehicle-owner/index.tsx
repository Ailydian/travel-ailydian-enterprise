    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        >
          ...
          <Link href="/commercial-vehicle-owner/vehicles/new">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-2 px-6 py-3 bg-transparent text-orange-600 rounded-xl font-bold shadow-lg hover:shadow-xl transition-all"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {stats.map((stat, index) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="bg-transparent rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all"
            >
        ...
        <motion.div
          ...
          className="bg-transparent rounded-2xl shadow-lg p-6 mb-8"
        >
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-white/10">
                  ...
                  <th className="text-left py-3 px-4 text-sm font-semibold text-gray-300">Tutar</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-gray-300">Durum</th>
                </tr>
              </thead>
              <tbody>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Link href="/commercial-vehicle-owner/vehicles">
            <motion.div
              whileHover={{ y: -5 }}
              className="bg-transparent rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all cursor-pointer"
            >
