          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="relative">
                  <Building className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-300" />
                  <input
                    type="text"
                    value={formData.companyName}
                    onChange={(e) => setFormData({ ...formData, companyName: e.target.value })}
                    className="w-full pl-10 pr-4 py-3 border border-white/20 rounded-xl focus:ring-2 focus:ring-orange-600 focus:border-white/20"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-12 py-3 border border-white/20 rounded-xl focus:ring-2 focus:ring-orange-600 focus:border-white/20"
                    placeholder="••••••••"
                    required />
            ...
            <div className="flex items-start">
              <input
                ...
                className="w-4 h-4 mt-1 text-orange-600 border-white/20 rounded focus:ring-orange-600"
                required />
