...
const VehicleOwnerDashboard: React.FC = () => {
  ...
  const vehicleTypeData = {
    ...
    datasets: [
    {
      ...
      backgroundColor: ['var(--lydian-info)', 'var(--lydian-success)', 'var(--lydian-warning)', 'var(--lydian-accent-purple)']
    }]
  ...
  const bookingStatusData = {
    ...
    datasets: [
    {
      ...
      backgroundColor: ['var(--lydian-success)', 'var(--lydian-info)', 'var(--lydian-warning)', 'var(--lydian-secondary)']
    }]
          ...
          <motion.div
            ...
            className="bg-lydian-error-lighter border border-red-200 rounded-lg p-4 mb-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div key={alert.id} className="text-sm text-lydian-primary-active mb-1">
            ...
            className="bg-gradient-to-br from-slate-900 via-black to-slate-800 rounded-xl shadow-md p-6">
              ...
              <div
                ...
                className="border border-white/20 rounded-lg p-4 hover:border-purple-300 transition-colors">
                    ...
                    'bg-red-100 text-lydian-primary-active' :
