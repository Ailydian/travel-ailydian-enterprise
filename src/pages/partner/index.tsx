  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20">
            ...
            <motion.div
              ...
              <motion.div
                ...
                className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 shadow-xl border border-slate-100">
                  ...
                  <div className="text-sm text-lydian-text-secondary">{stat.label}</div>
                </motion.div>
              )}
            </motion.div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <motion.h2
                ...
                viewport={{ once: true }}
                className="text-4xl md:text-5xl font-bold text-lydian-text mb-4">
              ...
              <motion.p
                ...
                className="text-xl text-lydian-text-secondary">
                  ...
                  <div className="relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl rounded-3xl p-8 shadow-2xl border border-slate-100 hover:shadow-blue-500/20 transition-all overflow-hidden">
                    ...
                    <div className="relative flex items-start gap-4 mb-6">
                      ...
                      <div className="flex-1">
                        <h3 className="text-2xl font-bold text-lydian-text mb-2">{partner.title}</h3>
                        <p className="text-lydian-text-secondary">{partner.description}</p>
                      </div>
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-6">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-lydian-text">{partner.stats.partners}</div>
                        <div className="text-xs text-lydian-text-tertiary">Partner</div>
                      </div>
                      <div className="text-center">
                        ...
                        <div className="text-xs text-lydian-text-tertiary">Puan</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-emerald-600">{partner.stats.avgBookings}</div>
                        <div className="text-xs text-lydian-text-tertiary">Rezervasyon</div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl p-4 mb-6">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-sm text-lydian-text-secondary">Ortalama Gelir</span>
                        <span className="text-2xl font-bold text-emerald-600">{partner.avgIncome}</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-lydian-text-secondary">Potansiyel Gelir</span>
                    ...
                    {/* Benefits Preview */}
                    <div className="mb-6">
                      <div className="text-sm font-semibold text-lydian-text mb-3">Öne Çıkan Avantajlar</div>
                      <div className="space-y-2">
                        {partner.benefits.slice(0, 3).map((benefit, i) =>
                      <div key={i} className="flex items-center gap-2 text-sm text-lydian-text-secondary">
                    ...
                    <div className="flex gap-3">
                      ...
                      className="px-6 py-3 bg-lydian-bg-surface-raised hover:bg-slate-200 text-lydian-text-secondary rounded-xl font-semibold transition-all">
                    ...
                    <motion.div
                      ...
                      className="overflow-hidden mt-6 pt-6 border-t border-white/20">
                          ...
                          <div className="mb-6">
                            ...
                            <p className="text-lydian-text-secondary leading-relaxed">{partner.longDescription}</p>
                          </div>

                          <div className="mb-6">
                            <h4 className="text-lg font-bold text-lydian-text mb-3">Tüm Özellikler</h4>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                              {partner.features.map((feature, i) =>
                          <div key={i} className="flex items-start gap-2">
                                  <Check className="w-4 h-4 text-emerald-600 flex-shrink-0 mt-0.5" />
                                  <span className="text-sm text-lydian-text-secondary">{feature}</span>
                                </div>
                          )}
                            </div>
                          </div>
                          ...
                          <div>
                            <h4 className="text-lg font-bold text-lydian-text mb-3">Tüm Avantajlar</h4>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                              {partner.benefits.map((benefit, i) =>
                          <div key={i} className="flex items-start gap-2">
                                  <Sparkles className="w-4 h-4 text-purple-600 flex-shrink-0 mt-0.5" />
                                  <span className="text-sm text-lydian-text-secondary">{benefit}</span>
                                </div>
                          )}
                            </div>
                          </div>
                          ...
                          <div className="mt-6 flex gap-3">
                            ...
                            <Link href={partner.dashboardUrl} className="flex-1">
                              <button className="w-full px-6 py-3 bg-lydian-bg-surface-raised hover:bg-slate-200 text-lydian-text-secondary rounded-xl font-semibold transition-all">
                                Dashboard
                              </button>
                            </Link>
                          </div>
        ...
        {/* Contact Section */}
        <section className="py-16 px-6 bg-lydian-bg-surface">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              ...
              <div>
                ...
                <h3 className="font-bold text-lydian-text mb-2">E-posta</h3>
                <p className="text-lydian-text-secondary">partner@lydian.com</p>
              </div>
              <div>
                <MessageCircle className="w-12 h-12 text-emerald-600 mx-auto mb-4" />
                <h3 className="font-bold text-lydian-text mb-2">Canlı Destek</h3>
                <p className="text-lydian-text-secondary">7/24 Online</p>
              </div>
            </div>
          </div>
        </section>
