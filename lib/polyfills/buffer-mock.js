 ...
 * Uses native buffer package for full compatibility
 */

// Always use the buffer package for maximum compatibility
try {
  ...
  // Fallback implementation if buffer package fails
